...
def run_server():
    ...
    # WS auth is a little different and described by bearer_ws
    # Add "disable_host_validation" : True here.
    options = {
        'security': 'bearer_sc',
        'security_ws': 'bearer_ws',
        'security_definitions': {
            "bearer_sc": {
                "scheme": "bearer",
                "alg": "HS256",
                "description": "A token must be configured for this thing",
